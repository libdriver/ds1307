...
| 21.10     | The Standard Library time and date functions shall not be used. | incompatible | We use this function to convert driver data and drivers guarantee the safety of the operation. | very low |

### Report

Detailed reports can be found in /misra/ds1307_polyspace_report.pdf.
